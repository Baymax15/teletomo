...
@SpringBootApplication(scanBasePackages = {"org.example.teletomo.modules.email", "org.example.teletomo.modules.intercoms"})
	...
	public IntercomsMessageHandler handler() {
		return new IntercomsMessageHandler() {
			...
			public String handle(String msg) {
				...
				return String.format("Handled message ('%s') in email module.", msg);
			}
